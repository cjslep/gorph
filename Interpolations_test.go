...
func TestCentripetalCubicCatmullRomInterpolationFourPoints(t *testing.T) {
	...
	AssertEqualsFloat64PointTolerance(t, pts[13], Float64Point{0.8236158926, 0.5139031847}, .000001, "Point 13 incorrect")
	AssertEqualsFloat64PointTolerance(t, pts[18], Float64Point{1.176384107, 0.4860968153}, .000001, "Point 18 incorrect")
	AssertEqualsFloat64PointTolerance(t, pts[19], Float64Point{1.25, 0.5}, .000001, "Point 19 incorrect")
	AssertEqualsFloat64PointTolerance(t, pts[20], Float64Point{1.308523901, 0.521054126}, .000001, "Point 20 incorrect")
	AssertEqualsFloat64PointTolerance(t, pts[30], Float64Point{1.928202449, 0.9505020745}, .000001, "Point 30 incorrect")
	LogVerbose(t, pts)
}
